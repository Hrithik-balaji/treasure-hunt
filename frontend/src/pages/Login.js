...
const s = {
  ...
  inp: { width:'100%', background:'rgba(0,0,0,0.4)', border:'1px solid rgba(201,168,76,0.3)', borderBottom:'2px solid rgba(201,168,76,0.5)', color:'#f5e9c8', padding:'13px 16px', fontFamily:"'Crimson Pro',serif", fontSize:16, outline:'none', transition:'all 0.3s' },
